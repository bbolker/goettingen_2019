...
& = (\beta_0 + \epsilon_{1,j}) + \beta_1 x_{ij} \\
\epsilon_{0,ij} & \sim \textrm{Normal}(0,\sigma_0^2) \\
\epsilon_{1,j} & \sim \textrm{Normal}(0,\sigma_0^2)
\end{split}
$$

Could have multiple, possibly nested levels of random effects
(genotype within population within region ...)
